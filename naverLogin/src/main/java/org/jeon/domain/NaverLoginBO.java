...
public class NaverLoginBO {
	private final static String CLIENT_ID = "k1rk0LL5u0DFxxa1b2Tp";
	private final static String CLIENT_SECRET = "Cryvecrw6m";
	private final static String REDIRECT_URI = "http://localhost:8080/users/callback";
